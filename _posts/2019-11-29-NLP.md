 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "Doing NLP with \"Friends\" : How Simple Feature Engineering Can Help\n",
    "# Introduction\n",
    ...
    "\n",
    "My goal of writing this blog is to highlight that getting very accurate prediction for a problem does not necessarily rely on the use of sophisticated a ML model. For classification problems, confusion  matrix or roc_auc curve can be a great  guide to understand how we can use simple feature engineering or resampling to improve prediction accuracy for linear ML models. \n",
    "\n",
    "This blog is a very short summary of some of the outcomes from the project. If you are interested to know about on all the aspects I explored in this project, please check out the project report in my github repo."
   ]
  },
  {
   "cell_type": "markdown",
